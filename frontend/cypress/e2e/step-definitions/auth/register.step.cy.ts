...
import RegisterPage from '../../../support/pages/auth/register.page';
...
Then(
  'o sistema bloqueia o cadastro e exibe uma mensagem informando que o e-mail já está cadastrado',
  () => {
...
Then(
  'o sistema bloqueia o cadastro e exibe uma mensagem informando que as senhas não coincidem',
  () => {
